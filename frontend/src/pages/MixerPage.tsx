...
export default function MixerPage({ projectId, onBack }: MixerPageProps) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-black relative overflow-hidden">
            ...
            {/* Player Transport com Loop - FIXO NA BASE */}
            <div className="fixed bottom-0 left-0 right-0 z-[100] p-4 bg-gray-900/90 backdrop-blur-2xl border-t border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
            ...
            {/* Espaçador para o player fixo não cobrir o conteúdo */}
